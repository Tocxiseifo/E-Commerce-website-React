...
import MacMini from '../assets/images/Mac-Mini-M4-PNG.png'
const Products = [
    {
        id:0,
...
export default function Product() {
    ...
    return(
        <>
            <section className="flex w-full h-auto flex-row flex-wrap  items-center ">
                  {Products.map((Product) => (
                        <div key={Product.id} className='flex flex-row justify-center  items-center w-full md:w-80 lg:w-100 md:ml-14 md:mb-6 lg:mb-0  [@media(min-width:2560px)]:w-140 h-auto lg:h-110'>
                            <div className='flex flex-col group'>
                                <div className='lg:h-70 w-50 relative h-50  bg-gray-100 flex flex-col gap-4 lg:w-70  rounded-lg overflow-hidden cursor-pointer mb-4'>
                                    <div className={Product.id === 3 ? 'h-80 relative bottom-8 lg:top-3 rounded-lg overflow=hidden mb-10 justify-center items-center hover:scale-110 duration-500 transition hover:duration-500' : 'h-80 relative  rounded-lg overflow=hidden mb-10 justify-center items-center hover:scale-110 duration-500 transition hover:duration-500'}>
                                        <img src={Product.img} alt="" className="bg-transparent"/>
                                    </div>
                                    {<button onClick={(e) =>{
                                        e.stopPropagation()
